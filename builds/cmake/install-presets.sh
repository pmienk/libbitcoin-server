...
display_constants()
{
    ...
    msg "libbitcoin_server_OWNER         : ${libbitcoin_server_OWNER}"
    msg "libbitcoin_server_TAG           : ${libbitcoin_server_TAG}"
}

help()
{
    msg "Script managing the build and installation of libbitcoin-server and its dependencies."
    msg ""
    msg "Script options:"
