...
display_toolchain_variables()
{
    ...
    display_message "CMAKE_PREFIX_PATH               : ${CMAKE_PREFIX_PATH}"
    display_message "CMAKE_INSTALL_PREFIX            : ${CMAKE_INSTALL_PREFIX}"
    display_message "CMAKE_INCLUDE_PATH              : ${CMAKE_INCLUDE_PATH}"
    display_message "CMAKE_LIBRARY_PATH              : ${CMAKE_LIBRARY_PATH}"
}
