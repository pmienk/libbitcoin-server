...
:main
    ...
    call :source_github "!libbitcoin_server_OWNER!" "libbitcoin-server" "!libbitcoin_server_TAG!"
    if %ERRORLEVEL% neq 0 (
        exit /b %ERRORLEVEL%
    )
...
:display_constants
    ...
    call :msg "libbitcoin_server_OWNER         : !libbitcoin_server_OWNER!"
    call :msg "libbitcoin_server_TAG           : !libbitcoin_server_TAG!"
    exit /b %ERRORLEVEL%
