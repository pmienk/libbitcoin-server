...
call :init pmienk libbitcoin-node cmake-icu-removal-integration
IF %ERRORLEVEL% NEQ 0 (
  call :failure "Initializing repository pmienk libbitcoin-node cmake-icu-removal-integration failed."
  exit /b 1
)
